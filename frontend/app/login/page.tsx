...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ background: 'var(--paper, #F5F3EE)' }}
    >
          ...
          <div className="w-full max-w-sm py-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label
                  htmlFor="email"
                  className="block text-[12px] uppercase tracking-wide mb-1.5"
        ...
        <div className="w-[70%] max-w-md">
          ...
          >
            <g transform="translate(30,40)">
              <path
                fill="#FFFFFF"
                d="M60 0 L120 45 L108 45 L108 110 L12 110 L12 45 L0 45 Z"
              />
              <rect
                fill="#9FC4E8"
                x="48"

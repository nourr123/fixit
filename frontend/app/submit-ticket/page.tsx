...
const SIGNAL_META: Record<Signal, { label: string; color: string; note: string }> = {
  idle: {
    label: '—',
    color: '#A9A296',
    note: 'Keep describing the issue to get a priority read.',
  },
  loading: {
    label: '…',
    color: '#A9A296',
  ...
  low: {
    label: 'Low',
    color: 'var(--low)',
    note: 'Reads as routine. A manager will confirm.',
  },
  medium: {
    label: 'Medium',
    color: 'var(--medium)',
    note: 'Reads as non-urgent but active. A manager will confirm.',
  },
  high: {
    label: 'High',
    color: 'var(--high)',
    note: 'Reads as urgent. Flagged for immediate review.',
  },
};
      ...
      <div className="flex-1 flex items-center justify-center px-4 min-h-0">
        <div
          ...
          style={{
            ...
            boxShadow: '0 1px 2px rgba(35,40,46,0.04)',
          }}
        >
          <div
          ...
          <div
            className="relative h-0 border-t border-dashed"
